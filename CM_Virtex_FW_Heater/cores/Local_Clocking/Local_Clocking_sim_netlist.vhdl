...
--               /mnt/scratch/rzou/CM_Virtex_FW_Heater_v1/cores/Local_Clocking/Local_Clocking_sim_netlist.vhdl
...
entity Local_ClockingLocal_Clocking_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of Local_ClockingLocal_Clocking_clk_wiz : entity is "Local_Clocking_clk_wiz";
end Local_ClockingLocal_Clocking_clk_wiz;

architecture STRUCTURE of Local_ClockingLocal_Clocking_clk_wiz is
  signal clk_200_Local_Clocking : STD_LOGIC;
  signal clk_50_Local_Clocking : STD_LOGIC;
  signal clk_axi_Local_Clocking : STD_LOGIC;
  signal clk_in1_Local_Clocking : STD_LOGIC;
...
entity Local_Clocking is
  ...
  attribute NotValidForBitStream of Local_Clocking : entity is true;
end Local_Clocking;

architecture STRUCTURE of Local_Clocking is
begin
inst: entity work.Local_ClockingLocal_Clocking_clk_wiz
     port map (
      clk_200 => clk_200,
      clk_50 => clk_50,
      clk_axi => clk_axi,
